...
<head>
    ...
    <style>
        ...
        /* Style the code block as needed */
        pre {
            padding: 1rem;
            ...
            overflow-x: auto;
            /* Add horizontal scrollbar if code overflows horizontally */
        }
    </style>
    ...
    <nav class="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
        ...
        <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div
                ...
                <a href="/" class="bg-black text-white rounded py-2 px-4 mx-2">Home</a>
                ...
                @endforeach
                <a href="/about-us" class="bg-blue-800 text-white rounded py-2 px-4 mx-2">About us</a>
            </div>
        </div>
